(function(){
    var blocking = {
        ...
        show : function(msg){
			...
			serial_number_ = "";
			try {
				if(stb.serial_number != '') {
					serial_number_ = "<br> Serial: " + stb.serial_number;
				}
			} catch (e) {
				
			}
            this.text_msg.innerHTML = (msg || get_word('cut_off_msg')) + " " + mac_  + serial_number_;
